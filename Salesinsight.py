  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/leonbenenati/Projeto_classificacao/blob/main/Salesinsight.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "df_limpo[[\"receita_total\", \"faixa_receita_item\"]]"
      ],
      "metadata": {
        "id": "hujHHuYAvpjV"
      },
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "gerar_visualizacoes(df_limpo, metricas=metricas)"
      ],
      "metadata": {
        "id": "bZoQNTLNxHD4"
      },
    ...
    },
    {
      ...
      "source": [
        "\n",
        "\n",
        "*   Coloquei plt.show() para aparecer o gráfico no notebook\n",
        "\n",
        "\n"
      ],
      "metadata": {
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "analisador = AnalisadorDeVendas(\"/content/vendas.csv\")\n"
      ],
      "metadata": {
        "id": "jJlYmglH032u"
      },
    ...
    },
    {
      ...
      "source": [
        "(\n",
        "    AnalisadorDeVendas(\"/content/vendas.csv\")\n",
        "    .carregar()\n",
        "    .limpar()\n",
        "    .transformar()\n",
        "    .analisar()\n",
    ...
    },
    {
      ...
      "source": [
        "analisador = (\n",
        "    AnalisadorComProjecao(\"vendas.csv\", meses_projecao=3)\n",
        "    .carregar()\n",
        "    .limpar()\n",
        "    .transformar()\n",
        "    .analisar()\n",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "df_limpo[[\"receita_total\", \"receita_total_transformado\"]]"
      ],
      "metadata": {
        "id": "N55n_G19B_NW"
      },
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "limpar_strings_com_regex(df_limpo)"
      ],
      "metadata": {
        "id": "-pDflIO_Htec"
      },
